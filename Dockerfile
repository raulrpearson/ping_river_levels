...
# https://elixirforum.com/t/npm-dependancy-and-production-build/58072/8
ARG NODE_BUILDER_IMAGE="node:22.11.0-alpine"
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/ping_river_levels ./
